...
function dePalabrasAFrase(palabras) {
  ...
  if(palabras.length==1){
    element = element.concat(palabras[numero],"");
  }else{
    do {
      element = element.concat(palabras[numero]," ");
      numero++;
    } while (numero<palabras.length-1);
      element = element.concat(palabras[numero],"");
  }
  return element;
}
...
function mesesDelAño(array) {
  ...
  if (!Meses.includes('Enero') || !Meses.includes('Noviembre') || !Meses.includes('Marzo') ) {
